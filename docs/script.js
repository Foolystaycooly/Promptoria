...
if (!navButtons.length) navButtons = $$(".nav-tabs .tab");
if (!navButtons.length) navButtons = $$("button[data-section]");
// ----------------------------
// Find sections
// ----------------------------
const sections = {};
...
if (toggleBtn && sidebar) {
  toggleBtn.addEventListener("click", () => {
    ...
    if (sidebar.classList.contains("active")) {
      toggleBtn.style.left = `${sidebar.getBoundingClientRect().width + 20}px`;
  ...
  document.addEventListener("click", (e) => {
    if (!sidebar.contains(e.target) && !toggleBtn.contains(e.target) && sidebar.classList.contains("active") && window.innerWidth < 900) {
...
// ----------------------------
// Nav button click handler (auto-close on mobile)
// ----------------------------
navButtons.forEach(btn => {
